...
def main(args):
    ...
    cv2.imwrite(f'./log/pred/pred_boundary.png',cv2.cvtColor(predboundary, cv2.COLOR_RGB2BGR))
    # plot
...
if __name__ == "__main__":
    ...
    p.add_argument('--loadmodel',type=str,default="./logs/checkpiont/checkpoint.pt")
    p.add_argument('--postprocess',type=bool,default=False)
    p.add_argument('--image_path',type=str,default="./test/45765448.jpg")
    args = p.parse_args()
